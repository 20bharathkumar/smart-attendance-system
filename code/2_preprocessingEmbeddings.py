...
dataset = "D:/AI_CLASS/attendance system using ML&DL/code/dataset"

embeddingFile = "D:/AI_CLASS/attendance system using ML&DL/code/output/embeddings.pickle" #initial name for embedding file
embeddingModel = "D:/AI_CLASS/attendance system using ML&DL/code/openface_nn4.small2.v1.t7" #initializing model for embedding Pytorch

#initialization of caffe model for face detection
prototxt = "D:/AI_CLASS/attendance system using ML&DL/code/model/deploy.prototxt"
model =  "D:/AI_CLASS/attendance system using ML&DL/code/model/res10_300x300_ssd_iter_140000.caffemodel"
